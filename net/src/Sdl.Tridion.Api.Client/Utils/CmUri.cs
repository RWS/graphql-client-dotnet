...
namespace Sdl.Tridion.Api.Client.Utils
{
    ...
    public class CmUri
    {
        ...
        public CmUri(ContentNamespace uriNamespace, int publicationId, int itemId, Sdl.Tridion.Api.Client.ItemType? itemType, int? version)
        {
        ...
        public static CmUri Create(ContentNamespace namespaceId, int publicationId, int itemId, Sdl.Tridion.Api.Client.ItemType itemType, int version) 
