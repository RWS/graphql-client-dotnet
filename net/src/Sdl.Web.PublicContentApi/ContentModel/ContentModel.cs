// This file was generated by a tool on 13/07/2018 11:44:05
...
namespace Sdl.Web.PublicContentApi.ContentModel
{
	...
	{
		/// <summary>
		/// Returns the binary component given given its CM_URI (takes precedence over the other arguments).ONLY if CM_URI is not specified, the binary is identified by its namespaceId, publicationId and binaryId. Alternatively a binary varinat URL can be used instead of a binary ID.
		/// </summary>
		...
		/// Get sitemap subtree
		/// </summary>
		public TaxonomySitemapItem SitemapSubtree { get; set; }
	}
	...
	public interface ITaxonomyItem
	{
		...
		/// Returns the item type of the item.
		/// </summary>
		Sdl.Web.PublicContentApi.ItemType ItemType { get; set; }
